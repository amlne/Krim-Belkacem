			...
			<div class="row">
				<nav class="navbar navbar-inverse">
					...
					<ul class="nav navbar-nav navbar-right col-lg-3">
						<li><a href="http://localhost:8080/projetLicence/prof"><span
								class="glyphicon glyphicon-user"></span> Compte</a></li>
						<li><a href="http://localhost:8080/projetLicence/deconnectionProf"><span class="glyphicon glyphicon-log-out"></span>
								Déconnection</a></li>
					</ul>
